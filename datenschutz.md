...
Wir erhalten die Daten &uuml;ber den Anbieter mit Hilfe von 

Rechtsgrundlage für diese Verarbeitung ist Art. 6 Abs. 1 lit. b) DSGVO.


#### Formsubmit
Um das Kontaktformular zu verarbeiten, setzen wir den Dienst FormSubmit von ein. Bei FormSubmit handelt es sich um einen Dienst der [Devro LABS](https://devrolabs.com/){: target:_blank}.
